...
```shell
uv run python src/datafun_01_foundations/app_danielson.py
```
...
1. Rename `app_danielson.py` to reflect your name or alias.
...
2. Edit this README.md file to change the run command to call your file instead.
   Use CTRL+f to search for `app_danielson.py` and replace all occurrences exactly.
